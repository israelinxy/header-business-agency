...
Este proyecto presenta una Header de una agencia de negocios preparado para una pantalla de 1200px de ancho.
...
```bash
git clone https://github.israelinxy/header-business-agency.git
```
